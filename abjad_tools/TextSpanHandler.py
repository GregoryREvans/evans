...
class TextSpanHandler:
    ...
    def __init__(
        ...
        list_one_left_only=False,
        list_two_left_only=False,
        list_three_left_only=False,
        continuous=False,
        ):
        def cyc(lst):
        ...
        self.list_one_left_only = list_one_left_only
        self.list_two_left_only = list_one_left_only
        self.list_three_left_only = list_one_left_only
    ...
    def add_spans(self, selections):
        if self.position_list_one != None:
            if self.list_one_left_only == True:
