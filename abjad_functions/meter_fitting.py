...
# abjad.f(timespan_list, scale=0.7, key='voice_name')
timespan_list
####
...
####
fitted_meters = abjad.Meter.fit_meters(argument=offset_counter, meters=permitted_meters, maximum_run_length=1)
