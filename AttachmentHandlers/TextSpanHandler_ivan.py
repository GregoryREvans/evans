...
class TextSpanHandler:
    def __init__(
        ...
        self._counters = {"span one": -1, "span two": -1, "span three": -1}
        self._spans = {
            r"One": (
                cyc(span_one_positions, "span one"),
                self.span_one_style,
                self.span_one_padding,
                self.attach_span_one_to,
            ),
            r"Two": (
                cyc(span_two_positions, "span two"),
                self.span_two_style,
                self.span_two_padding,
                self.attach_span_two_to,
            ),
            r"Three": (
                cyc(span_three_positions, "span three"),
                self.span_three_style,
                self.span_three_padding,
                self.attach_span_three_to,
            ),
        }
