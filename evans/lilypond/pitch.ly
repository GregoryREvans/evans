...
accidentalGlyphs = #`(
    ...
    (,Eleven-Twelf-Sharp . "scripts.umarcato")
    (,Seven-Eighth-Sharp . "scripts.halfopenvertical")
    (,Five-Sixth-Sharp . "accordion.pull")
    (,Three-Quarter-Sharp . "accidentals.sharp.slashslash.stemstemstem")
    (,Two-Third-Sharp . "accidentals.sharp.slashslashslash.stemstem")
    (,Five-Eighth-Sharp . "accidentals.sharp.arrowup")
    (,STwelf-Sharp . "accidentals.vaticanaM1")
    (,Sharp . "accidentals.sharp")
    (,Five-Twelf-Sharp . "accidentals.mensural1")
    (,Three-Eighth-Sharp . "accidentals.sharp.arrowdown")
    (,Third-Sharp . "accidentals.sharp.slashslashslash.stem")
    (,Quarter-Sharp . "accidentals.sharp.slashslash.stem")
    (,Sixth-Sharp . "accidentals.kievan1")
    (,Eighth-Sharp . "accidentals.natural.arrowup")
    (,Twelf-Sharp . "plus")
    (,Natural . "accidentals.natural")
    (,Twelf-Flat . "hyphen")
    (,Eighth-Flat . "accidentals.natural.arrowdown")
    (,Sixth-Flat . "accidentals.mirroredflat.backslash")
    (,Quarter-Flat . "accidentals.mirroredflat")
    (,Third-Flat . "accidentals.flat.slash")
    (,Three-Eighth-Flat . "accidentals.flat.arrowup")
    (,Five-Twelf-Flat . "accidentals.kievanM1")
    (,Flat . "accidentals.flat")
    (,STwelf-Flat . "accidentals.mensuralM1")
    (,Five-Eighth-Flat . "accidentals.flat.arrowdown")
    (,Two-Third-Flat . "accidentals.flat.slashslash")
    (,Three-Quarter-Flat . "accidentals.mirroredflat.flat")
    (,Five-Sixth-Flat . "accidentals.hufnagelM1")
    (,Seven-Eighth-Flat . "accidentals.rightparen")
    (,Eleven-Twelf-Flat . "accidentals.vaticana0")
