...
class Sequence(baca.Sequence):
    ...
    def chen(class_, a, b, c, first_state, time_values, iters):
        ...
        .. container:: example
            ...
            ...
            >>> print(c)
            Sequence([[-0.1, 0.12465461315287779, 0.34050473218831584, 0.5770360314308267, 0.862664481582161, 1.2283126392857153, 1.7104499742301056, 2.3534686146396973, 3.210342581973771, 4.3384999630660195], [0.5, 0.6622702530766479, 0.8942439508177753, 1.2176463222616836, 1.66295375321105, 2.2713555330407713, 3.096546852300223, 4.204669803361288, 5.668029113688401, 7.542293510840851], [-0.6, -0.5821525955103404, -0.5631370288024949, -0.5417183868578876, -0.5155298081524367, -0.48013350192305515, -0.427302710012795, -0.341985244048448, -0.19722719758314788, 0.053376301346095195]])
    ...
    def lorenz(class_, rho, sigma, beta, first_state, time_values, iters):
        ...
        .. container:: example
            ...
            ... )
            ...
            Sequence([[1.0, 1.0125657408032651, 1.0488214579592035, 1.1072062990344544, 1.186865484233381, 1.2875548011090359, 1.4095688012763319, 1.5536887870511122, 1.721145788631948, 1.9135963877769733], [1.0, 1.2599200056984294, 1.5240008388892075, 1.7983145777648861, 2.08854553527816, 2.4001603988257716, 2.7385521044801306, 3.1091609970576917, 3.5175771318813633, 3.9696234877370755], [1.0, 0.9848910446848754, 0.9731143416309531, 0.9651591023109145, 0.9617373815250438, 0.9638062240116597, 0.9726082787069015, 0.9897311952182218, 1.0171865646618778, 1.057511871629279]])
    ...
    def lu_chen(class_, a, b, c, u, first_state, time_values, iters):
        ...
        .. container:: example
            ...
            ... )
            ...
            Sequence([[0.1, 0.14507340240351368, 0.14323815901530343, 0.10128972203257036, 0.02212510661501932, -0.0944653354105579, -0.25134777506809236, -0.4538520580544356, -0.7097811725420128, -1.0295889433224694], [0.3, 0.2009288005589258, 0.08027594159872474, -0.06748948170440208, -0.2490165225972874, -0.4723839158805825, -0.7474651998093494, -1.0863625805752992, -1.5039237075444878, -2.018352110108072], [-0.6, -0.5819559886254811, -0.5645492876975079, -0.5478486760664361, -0.5317444633853428, -0.5158905397379729, -0.4995950638053595, -0.48163813037580316, -0.459981413894839, -0.43131546553144107]])
