...
class SegmentMaker:
                ...
                for measure_group, duration_group in zip(
                    ...
                    if not any(group_parents_booleans):
                        ...
                        for old_indicator in old_starting_indicators:
                            abjad.attach(
                                old_indicator, new_starting_leaf_target
                            )  # how to preserve direction across replacement?
                ...
                for _attachment in music_command.attachments:
                    ...
                    if isinstance(
                        ...
                        for site in attachment_site:
                            abjad.attach(
                                _attachment.indicator,
                                site,
                                direction=_attachment.direction,
                            )
                    else:
                        abjad.attach(
                            _attachment.indicator,
    ...
    def _render_file(self):
        ...
        if self.with_layout is False:
            ...
            )  # WARNING: this causes trouble in building all segments by iterating from directory above?
