...
class CompositeMusicSpecifier(HashCachingObject):
    ...
    def __init__(
        ...
        prototype = evans.consort_reviv.MusicSpecifierSequence
        ...
        if not isinstance(primary_music_specifier, prototype):
            primary_music_specifier = evans.consort_reviv.MusicSpecifierSequence(
        ...
        if not isinstance(secondary_music_specifier, prototype):
            secondary_music_specifier = evans.consort_reviv.MusicSpecifierSequence(
    ...
    def __call__(
        ...
        if self.discard_inner_offsets:
            ...
            secondary_durations = evans.consort_reviv.rotate(
                primary_durations,
