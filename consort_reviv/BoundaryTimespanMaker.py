...
class BoundaryTimespanMaker(TimespanMaker):
    ...
    def __init__(
        ...
        if start_talea is not None:
            if not isinstance(start_talea, abjadext.rmakers.Talea):
            ...
            assert isinstance(start_talea, abjadext.rmakers.Talea)
        ...
        if stop_talea is not None:
            if not isinstance(stop_talea, abjadext.rmakers.Talea):
            ...
            assert isinstance(stop_talea, abjadext.rmakers.Talea)
