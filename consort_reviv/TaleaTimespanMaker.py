...
from evans.consort_reviv.TimespanMaker import TimespanMaker
...
class TaleaTimespanMaker(TimespanMaker):
    ...
    def __init__(
        ...
        if initial_silence_talea is not None:
            assert isinstance(initial_silence_talea, abjadext.rmakers.Talea)
        ...
        assert isinstance(playing_talea, abjadext.rmakers.Talea)
        ...
        if silence_talea is not None:
            assert isinstance(silence_talea, abjadext.rmakers.Talea)
    ...
    def _make_with_synchronized_step(
        ...
        while start_offset < stop_offset and can_continue:
            ...
            if self.step_anchor == abjad.Right and timespan_inventory:
